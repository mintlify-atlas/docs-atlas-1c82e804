...
3. Check the [Features](/features/axes) section for detailed component documentation
4. Review [VCL Samples](/vcl/overview) and [FMX Samples](/fmx/overview) for more examples
